...
**Definition :**
$E = (base, enrichers, combine, output)$

- $base : BaseData$ is input data to enrich
- $enrichers : Set⟨Enricher⟩$ is enrichment sources
- $output : EnrichedData$ is enriched result
