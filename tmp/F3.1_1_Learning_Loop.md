...
**Definition F3.1:**
A learning loop is a tuple $L = (observe, learn, update, apply)$ where:
- $observe : Environment → Observations$ collects data
- $learn : Observations → Model$ trains or updates model
- $update : Model → Policy$ updates decision policy
- $apply : Policy → Actions$ applies learned policy
